...
# Custom Deployment Script for Your AWS Instances
# ELK Stack: 100.26.191.27 (Private: 172.31.81.26)
# Honeypot: 54.165.107.7 (Private: 172.31.84.247)

set -e

echo "🚀 AWS Honeypot System Deployment for Your Instances"
echo "===================================================="
...
# SSH key path - you'll need to update this
...
if [ ! -f "$KEY_PATH" ]; then
    ...
    echo "1. Download your SSH key from AWS Console"
    echo "2. Save it as: $KEY_PATH"
    echo "3. Run: chmod 400 $KEY_PATH"
    echo "4. Then run this script again"
    echo ""
    echo "If your key is in a different location, update KEY_PATH in this script"
    exit 1
fi
...
print_status "⏳ Waiting for ELK services to stabilize (60 seconds)..."
sleep 60
...
print_status "Waiting for honeypot instance to reboot (90 seconds)..."
sleep 90
